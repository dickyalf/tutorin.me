    ...
    <head>
        ...
        {{-- <style>
            ...
            top: 0;
            left: 0;
            z-index: 3000; /* Higher than backdrop */
            /* display: none; */
            width: 100%;
            height: 100%;
            overflow-x: hidden;
                        ...
                        <div class="account-box">
                            ...
                            <div class="login-right">
                                ...
                                <form action="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check form-check-xs custom-checkbox">
                                            ...
                                            <label class="form-check-label" for="agree_checkbox_user">I setuju untuk
                                                menjadi
                                                tutor dan sudah membaca </label>
                                            <a tabindex="-1" href="javascript:void(0);" data-toggle="modal"
                                                data-target="#termsModal" class="custom-link">Syarat dan Ketentuan</a>
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Syarat
                                                                dan
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                ...
                                                                dilakukan oleh orangtua atau wali yang sah atas nama
                                                                Anda.
                                                                <br>2.Proses Pendaftaran
                                                                Lengkapi formulir pendaftaran online dengan informasi
                                                                yang
                                                                diperlukan, termasuk data pribadi, kualifikasi
                                                                pendidikan,
                                                                dan pengalaman mengajar.
                                                                Semua dokumen pendukung (seperti sertifikat pendidikan
                                                                dan
                                                                identifikasi diri) harus diunggah dan diverifikasi oleh
                                                                tim
                                                                kami.
                                                                ...
                                                                deskripsi kelas, termasuk judul, konten, jadwal, dan
                                                                biaya.
                                                                ...
                                                                Tutor harus memberikan kelas sesuai dengan deskripsi
                                                                yang
                                                                telah diposting dan memastikan kualitas pengajaran yang
                                                                tinggi.
                                                                Kelas online yang dibuat wajib menggunakan platform
                                                                video
                                                                call Tutorin.
                                                                ...
                                                                Dengan menggunakan layanan kami, Anda memberikan
                                                                persetujuan
                                                                kepada kami untuk menggunakan data Anda untuk
                                                                tujuan-tujuan
                                                                tersebut.
                                                                ...
                                                                Murid dapat memberikan penilaian dan umpan balik
                                                                terhadap
                                                                kelas yang diambil. Penilaian ini akan dipublikasikan di
                                                                profil tutor.
                                                                Tutor yang memiliki pelanggan setia dan menerima ulasan
                                                                positif secara konsisten akan mendapatkan poin lebih
                                                                tinggi
                                                                di area umpan balik. Poin ini akan meningkatkan
                                                                visibilitas
                                                                ...
                                                                penghentian akun.
                                                                Tutorin berhak untuk menghapus konten yang melanggar
                                                                atau
                                                                ...
                                                                Tutor diharapkan untuk secara rutin memeriksa halaman
                                                                ini
                                ...
                                <a href="{{ route('student-view') }}"><button class="btn btn-primary login-btn"
                                        type="submit">Buat Akun</button></a>
                                <div class="account-footer text-center mt-3">
                                    Already have an account? <a class="forgot-link mb-0"
                                        href="{{ route('login') }}">Login</a>
                                </div>
